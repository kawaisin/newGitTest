	...
	if ( $image_url ) :
		...
		<header class="content-header-image">
			<div class="<?php echo $image_class; ?>" style="background-image: url('<?php echo $image_url; ?>')">
				...
				<?php if ( $subtitle ) echo '<h2 class="header-image-description">Grand Central Tech is thrilled to announce the launch of the HUB@GCT</h2>'; ?>
				...
				//	echo '<a href="#pagetop" class="scroll-down smoothscroll"><div class="mouse"><div class="wheel"></div></div><div><span class="unu"></span> <span class="doi"></span> <span class="trei"></span> </div></a>';
					echo '<a href="#pagetop" class="scroll-down smoothscroll"><span class="glyphicon"></span></a>';
				}
				?>
				<?php				
				// Only for blog page, show Text
				if ( is_home() ) {
					echo '<div class="eds-animate animated fadeInUp" data-eds-entry-animation="bounceIn" data-eds-entry-delay="0.8" data-eds-entry-duration="0.5" data-eds-entry-timing="ease-in" data-eds-entry-count="1" style="animation-duration: 0.5s; animation-delay: 0s; animation-timing-function: ease-in;"><h2>Three Thirty Five</h2></div>';
				}
				elseif ( is_single() ) {
					echo '<h2>';
					echo get_the_title();
